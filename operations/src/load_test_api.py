...
from operations.src.admin_dto import DTO
from operations.src.load_test_store import LoadRequest, report_csv
...
def create_load_test_router(service):
    ...
    def report(rid: str, format: Literal["json", "csv"] = "json"):
        ...
        return Response(
            ...
            headers={
                "Content-Disposition": f'attachment; filename="{result["id"]}.{format}"'
            },
        )
