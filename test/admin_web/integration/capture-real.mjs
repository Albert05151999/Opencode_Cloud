...
try {
  ...
  await page.screenshot({path:'../../artifacts/admin_web/screenshots/real-chat-desktop.png',fullPage:true});
  ...
  await page.screenshot({path:'../../artifacts/admin_web/screenshots/real-admin-desktop.png',fullPage:true});
